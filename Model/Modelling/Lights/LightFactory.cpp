...
shared_ptr<Light> LightFactory::createLight(vec3 posicio, vec3 Ia, vec3 Id, vec3 Is, float a, float b, float c, vec3 direction, float opening, LIGHT_TYPES t) {
    shared_ptr<Light> l;
    switch(t) {
    case POINTLIGHT:
        ...
        break;
    case DIRECTIONALLIGHT:
        l = make_shared<DirectionalLight>(direction, Ia, Id, Is);
        break;
    case SPOTLIGHT:
        l = make_shared<SpotLight>(posicio, direction, opening, Ia, Id, Is, a, b, c);
        break;
    default:
        break;
    }
